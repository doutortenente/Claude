...
Do not conclude that no projects or deployments exist after checking only one relevant scope. If several plausible
targets remain, ask the user to choose from the candidates found. Avoid broad enumeration across unrelated teams unless
the user asked for account-wide investigation.
