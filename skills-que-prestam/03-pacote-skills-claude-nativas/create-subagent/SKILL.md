...
Subagentes são assistentes especializados que rodam em contexto isolado, com system prompt próprio. Servem pra
**preservar contexto** (isolar exploração da conversa principal), **especializar comportamento** e **reaproveitar**
configurações entre projetos.
...
Quando dois subagentes têm o mesmo nome, o de maior prioridade vence. Subagentes de projeto (`.claude/agents/`) podem ir
pro controle de versão pra compartilhar com o time.
