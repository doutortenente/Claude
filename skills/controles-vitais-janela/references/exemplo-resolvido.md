...
1. **SITREP** (1–2 linhas): qual folha, qual janela, quantos leitos.
   Ex.: `🦅 SITREP — NOVO PLANTÃO / UTI ADULTO 2 — 10/06/2026 — 3 LEITOS`
2. **Blocos** copiar-e-colar (limpos), um por leito.
3. **Flags vermelhos** (fora do bloco): leitos que exigem reavaliação AGORA.
   Ex.: `⚠ FC fixa em 60 bpm em 9/12 aferições — marcapasso/betabloqueio. Glic 126→222.`
...
Sem prescrição na mão = SEM dose inventada. Folha de enfermagem não traz
infusão nominal legível → não cravar mcg/kg/min nem UI de insulina.
