...
Detalhe: `.claude/rules/communication.md`.
...
| --- | --- |
| Onde mora X, quem chama X | MCP `jetbrains-index` (`ide_find_file`, `ide_search_text`) |
...
Detalhe: `.claude/rules/repository-navigation.md`.
