...
**Total:** 917 arquivos · 19.4 MB · 103,466 linhas · 514,774 tokens indexados · **64 skills**
...
| `docs` | 4 | 9,243 | `docs/` — manual, inventário, decisões, runbook |
| `skill_ide` | 8 | 8,619 | Pacote 00 — IDE e documentação |
| `governance` | 12 | 6,508 | `.claude/` — rules, skills, agents, hooks, settings |
